...
public class Node : MonoBehaviour {
    ...
    {
        //Calcular la fuerza local del nodo
        Vector3 g = new Vector3(Mass * Manager.Gravity.x, Mass * Manager.Gravity.y, Mass * Manager.Gravity.z);
        ...
        //SUMAR esa fuerza al vector global de la simulación
